...
const tanggal = (numer) => {
	myMonths = ["January","February","March","April","Mei","Jun","July","August","September","October","November","December"];
	myDays = ['Week','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday']; 
